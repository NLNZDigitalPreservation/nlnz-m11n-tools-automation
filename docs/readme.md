# nlnz-m11n-tools-automation documentation
### https://nlnz-m11n-tools-automation.readthedocs.io/en/latest/
NLNZ M11N Tools Automation documentation is written using the ReStructuredText format and hosted on readthedocs.org.
...
The following is the structure committed to the nlnz-m11n-tools-automation git project. There are additional
...
#### Build
Using the make files located in the nlnz-m11n-tools-automation docs folder, build the documentation.
