...
class GitCommander {
    ...
    nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand()
    ...
    def getBranchHash(String gitFolder, String branchName) {
        ...
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand specificShellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand()
    ...
    nz.govt.natlib.m11n.tools.automation.shell.ShellCommand applyPatch(String gitFolder, File patchFile, boolean exceptionIfPatchFails = true) {
        File folder = new File(gitFolder)
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand specificShellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand()
        specificShellCommand.showOutput = shellCommand.showOutput
