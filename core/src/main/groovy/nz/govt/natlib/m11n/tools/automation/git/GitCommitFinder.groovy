...
class GitCommitFinder {
    ...
    String listTags(File gitFolder) throws AutomationException {
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: "Unable to find matching tags")
    ...
    String getCurrentCommit(File gitFolder) throws AutomationException {
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: "Unable to find current commit")
    ...
    String findCurrentBranch(File gitFolder) throws AutomationException {
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: "Unable to find current branch")
    ...
    String findChangesSinceCurrentCommit(File gitFolder) throws AutomationException {
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: "Unable to find changes since current commit")
    ...
    String findCurrentOriginUrl(File gitFolder) throws AutomationException {
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: "Unable to find current origin URL")
    ...
    String cherryCommitsInOriginBranch(String branchName, File gitFolder) throws AutomationException {
        ...
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: "Unable to find if there are cherry commits in origin")
