...
import nz.govt.natlib.m11n.tools.automation.file.FilePathDifferenceExtractor
...
class GitDifferenceFinder {
    ...
    nz.govt.natlib.m11n.tools.automation.shell.ShellCommand executeCommand(String baseCommand, String exceptionMessagePrefix, File gitFolder,
        ...
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand shellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: exceptionMessagePrefix)
    ...
    boolean hasRepositoryChangedSinceCommit(String commitHash, File gitRootFolder, File includeFolder,
        ...
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand changesWithStaged = executeCommand(baseCommand, "Unable to find changes", gitRootFolder, CACHED_OPTION, includeFolder, excludeFolders)
        ...
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand changesWithUnstaged = executeCommand(baseCommand, "Unable to find changes", gitRootFolder, null, includeFolder, excludeFolders)
        ...
        nz.govt.natlib.m11n.tools.automation.shell.ShellCommand untrackedShellCommand = new nz.govt.natlib.m11n.tools.automation.shell.ShellCommand(exceptionOnError: true, exceptionMessagePrefix: "Unable to find untracked")
